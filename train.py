...
def load_dataset(path, split=0.1):
    ...
    for index, row in df.iterrows():
        ...
        image = os.path.join(path, "bbox", image_index)
        # bbox = [x1, y1, x2, y2]
    ...
    train_labels, test_labels = train_test_split(train_labels, test_size=split_size, random_state=42)

    # return (train_x, train_y), (valid_x, valid_y), (test_x, test_y)
    return (train_x, train_y, train_labels), (valid_x, valid_y, valid_labels), (test_x, test_y, test_labels)
...
if __name__ == "__main__":
    ...
    (train_x, train_y, train_labels), (valid_x, valid_y, valid_labels), (test_x, test_y, test_labels) = load_dataset(dataset_path, split=0.1)
...
#     df = pd.read_excel("data/BBox_List_2017.xlsx", index_col=None)
...
#         image = os.path.join(path, "data/images", name)
#         bbox = [x1, y1, x2, y2]
...
#     lr = 1e-4
#     num_epochs = 20
#     model_path = os.path.join("files", "mamas_model.h5")
#     csv_path = os.path.join("files", "log.csv")
